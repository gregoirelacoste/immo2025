/**
 * Georisques data collection (natural and technological risks).
 * Source: georisques.gouv.fr/api/v1 — open access, no auth required.
 */
...
/** Flood risk codes (GASPAR) */
const FLOOD_CODES = ["13", "14", "15", "16"];

/** Compute overall risk level from individual risk indicators */
...
/**
 * Fetch risk data for a city. Calls 4 endpoints in parallel.
 */
