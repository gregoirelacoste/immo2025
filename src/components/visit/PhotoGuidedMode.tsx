      ...
      <div className="fixed inset-0 z-60 bg-white overflow-y-auto" style={{ paddingTop: "var(--sat)", paddingBottom: "var(--sab)" }}>
        <div className="max-w-lg mx-auto px-4 py-6 space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-bold text-gray-900">Recap photos</h2>
            <button
              type="button"
              onClick={onClose}
              className="text-sm text-indigo-600 font-medium min-h-[44px] px-3"
            >
              Terminer
            </button>
          </div>
  ...
  return (
    <div className="fixed inset-0 z-60 bg-gray-50 flex flex-col" style={{ paddingTop: "var(--sat)", paddingBottom: "var(--sab)" }}>
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 shrink-0">
        <div className="flex items-center justify-between mb-2">
          <button
            type="button"
            onClick={onClose}
            className="text-sm text-gray-600 hover:text-gray-900 min-h-[44px] flex items-center gap-1"
          >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-6 space-y-6">
        {/* Step card */}
        <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-200 p-6 text-center space-y-3">
        ...
        <input
          ...
          className="w-full max-w-sm text-sm px-4 py-2.5 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
        />
        ...
        <div className="w-full max-w-sm space-y-2">
          <button
            ...
            disabled={capturing}
            className="w-full bg-indigo-600 text-white font-semibold py-3 rounded-xl min-h-[48px] hover:bg-indigo-700 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
          >
            {capturing ? (
        ...
        <button
          ...
          className="text-sm text-indigo-600 hover:text-indigo-700 font-medium min-h-[44px] flex items-center gap-1"
        >
          {freeCapturing ? (
