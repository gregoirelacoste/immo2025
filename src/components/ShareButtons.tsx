...
export default function ShareButtons({ url, title, description }: Props) {
  ...
  const linkClass =
    "inline-flex items-center justify-center w-9 h-9 rounded-full text-gray-500 hover:text-amber-700 hover:bg-amber-50 transition-colors";
  ...
  return (
    <div className="flex items-center gap-1 flex-wrap">
      ...
      >
        {copied ? (
          <span className="text-xs font-medium text-amber-600">Copié !</span>
        ) : (
