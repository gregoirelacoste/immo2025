/**
 * Collecte de données INSEE (Données Locales).
 * Source : api.insee.fr — nécessite authentification OAuth2.
 *
...
/** Vérifie si les credentials INSEE sont configurées */
...
/**
 * Récupère les données socio-économiques INSEE pour une commune.
 * Retourne null si les credentials ne sont pas configurées.
 */
